      ...
      <main className="bg-background-white">
        ...
        <section className="py-16 md:py-20 bg-background-light">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-8 animate-fade-in-up">
              See TrainerHub in Action
            </h2>
            <p className="text-base md:text-lg text-secondary mb-8 leading-relaxed animate-fade-in-up">
              Watch how easy it is to manage your fitness business with our intuitive platform
            </p>
            <div className="relative bg-white rounded-xl shadow-lg p-8 md:p-12 animate-fade-in-up">
              <div className="aspect-video bg-gradient-to-br from-main/10 to-purple-100 rounded-lg flex items-center justify-center">
                <Button
                  onClick={() => setIsVideoPlaying(!isVideoPlaying)}
                  className="w-16 h-16 md:w-20 md:h-20 bg-main text-white rounded-full flex items-center justify-center hover:bg-main-dark transition-all duration-300 transform hover:scale-110"
                >
                  <Play className="h-8 w-8 md:h-10 md:w-10 ml-1" />
                </Button>
              </div>
              <div className="mt-6 text-sm text-secondary">
                {isVideoPlaying ? "Demo video playing..." : "Click to watch demo"}
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-20 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              {/* Trainer Card */}
              <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 border border-gray-100 hover:shadow-xl transition-all duration-300 transform hover:scale-105 animate-fade-in-up">
                <div className="flex flex-col items-center text-center">
                  <div className="w-16 h-16 md:w-20 md:h-20 bg-main/10 rounded-full flex items-center justify-center mb-6 animate-float">
                    <Users className="h-8 w-8 md:h-10 md:w-10 text-main" aria-label="Trainer Icon" />
                  </div>
                  <h3 className="text-xl md:text-2xl font-bold text-primary mb-4">I'm a Trainer</h3>
                  ...
                  <Button
                    size="lg"
                    onClick={() => setShowModal(true)}
                    className="flex items-center gap-2 w-full sm:w-auto text-base px-6 py-3 font-semibold shadow-md hover:shadow-lg transition-all duration-300"
                  >
                    Continue as Trainer →
                  </Button>
                </div>
              ...
              <div className="bg-gray-50 rounded-xl shadow-lg p-6 md:p-8 border border-gray-200 opacity-60 animate-fade-in-up">
                <div className="flex flex-col items-center text-center">
                  <div className="w-16 h-16 md:w-20 md:h-20 bg-gray-200 rounded-full flex items-center justify-center mb-6">
                    <Users className="h-8 w-8 md:h-10 md:w-10 text-gray-400" aria-label="Client Icon" />
                  </div>
                  <h3 className="text-xl md:text-2xl font-bold text-gray-500 mb-4">I'm a Client</h3>
                  ...
                  <Button
                    disabled
                    size="lg"
                    className="flex items-center gap-2 w-full sm:w-auto text-base px-6 py-3 font-semibold bg-gray-300 text-gray-500 cursor-not-allowed"
                  >
                    Coming Soon →
                  </Button>
                </div>
